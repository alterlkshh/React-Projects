...
// node_modules/react-chat-engine-pretty/dist/react-chat-engine-pretty.esm.js
...
var LiveRegion = function LiveRegion2(props) {
  ...
  var ariaSelected = (0, import_react6.useMemo)(function() {
    ...
    if (ariaSelection && messages.onChange) {
      var option2 = ariaSelection.option, selectedOptions = ariaSelection.options, removedValue = ariaSelection.removedValue, removedValues = ariaSelection.removedValues, value = ariaSelection.value;
      var asOption = function asOption2(val) {
        return !Array.isArray(val) ? val : null;
      };
      var selected = removedValue || option2 || asOption(value);
...
var defaultStringify = function defaultStringify2(option2) {
  return "".concat(option2.label, " ").concat(option2.value);
};
var createFilter = function createFilter2(config) {
  return function(option2, rawInput) {
    if (option2.data.__isNew__)
      return true;
    ...
    var candidate = trim2 ? trimString(stringify2(option2)) : stringify2(option2);
    if (ignoreCase) {
...
var getOptionLabel$1 = function getOptionLabel(option2) {
  return option2.label;
};
var getOptionValue$1 = function getOptionValue(option2) {
  return option2.value;
};
var isOptionDisabled = function isOptionDisabled2(option2) {
...
function toCategorizedOption(props, option2, selectValue, index2) {
  var isDisabled = _isOptionDisabled(props, option2, selectValue);
  var isSelected = _isOptionSelected(props, option2, selectValue);
  var label = getOptionLabel2(props, option2);
  var value = getOptionValue2(props, option2);
  return {
    type: "option",
    data: option2,
    isDisabled,
...
function buildCategorizedOptions(props, selectValue) {
  return props.options.map(function(groupOrOption, groupOrOptionIndex) {
    if ("options" in groupOrOption) {
      var categorizedOptions = groupOrOption.options.map(function(option2, optionIndex) {
        return toCategorizedOption(props, option2, selectValue, optionIndex);
...
function buildFocusableOptionsFromCategorizedOptions(categorizedOptions) {
  return categorizedOptions.reduce(function(optionsAccumulator, categorizedOption) {
    if (categorizedOption.type === "group") {
      optionsAccumulator.push.apply(optionsAccumulator, _toConsumableArray(categorizedOption.options.map(function(option2) {
        return option2.data;
      })));
    } else {
...
function _isOptionDisabled(props, option2, selectValue) {
  return typeof props.isOptionDisabled === "function" ? props.isOptionDisabled(option2, selectValue) : false;
}
function _isOptionSelected(props, option2, selectValue) {
  if (selectValue.indexOf(option2) > -1)
    return true;
  if (typeof props.isOptionSelected === "function") {
    return props.isOptionSelected(option2, selectValue);
  }
  var candidate = getOptionValue2(props, option2);
  return selectValue.some(function(i) {
    return getOptionValue2(props, i) === candidate;
  });
}
function _filterOption(props, option2, inputValue) {
  return props.filterOption ? props.filterOption(option2, inputValue) : true;
}
...
var Select = function(_Component) {
  ...
  function Select2(_props) {
    ...
    _this.setValue = function(newValue, action, option2) {
  ...
  _createClass(Select2, [{
    ...
    value: function isOptionDisabled3(option2, selectValue) {
      return _isOptionDisabled(this.props, option2, selectValue);
    }
  }, {
    key: "isOptionSelected",
    value: function isOptionSelected(option2, selectValue) {
      return _isOptionSelected(this.props, option2, selectValue);
    }
  }, {
    key: "filterOption",
    value: function filterOption(option2, inputValue) {
      return _filterOption(this.props, option2, inputValue);
    }
  }, {
    ...
    value: function renderMenu() {
      ...
      var commonProps = this.commonProps;
      var focusedOption = this.state.focusedOption;
      var _this$props12 = this.props, captureMenuScroll = _this$props12.captureMenuScroll, inputValue = _this$props12.inputValue, isLoading = _this$props12.isLoading, loadingMessage2 = _this$props12.loadingMessage, minMenuHeight = _this$props12.minMenuHeight, maxMenuHeight = _this$props12.maxMenuHeight, menuIsOpen = _this$props12.menuIsOpen, menuPlacement = _this$props12.menuPlacement, menuPosition = _this$props12.menuPosition, menuPortalTarget = _this$props12.menuPortalTarget, menuShouldBlockScroll = _this$props12.menuShouldBlockScroll, menuShouldScrollIntoView = _this$props12.menuShouldScrollIntoView, noOptionsMessage3 = _this$props12.noOptionsMessage, onMenuScrollToTop = _this$props12.onMenuScrollToTop, onMenuScrollToBottom = _this$props12.onMenuScrollToBottom;
      if (!menuIsOpen)
        return null;
      ...
      if (this.hasOptions()) {
        menuUI = this.getCategorizedOptions().map(function(item) {
          if (item.type === "group") {
            ...
            }), item.options.map(function(option2) {
              return render(option2, "".concat(groupIndex, "-").concat(option2.index));
            }));
        ...
        var _message = noOptionsMessage3({
          inputValue
        });
        if (_message === null)
          return null;
    ...
    value: function renderFormField() {
      ...
      if (isMulti) {
        if (delimiter2) {
          ...
          return React4.createElement("div", null, input2);
        }
      } else {
...
var useIsMobile = function useIsMobile2() {
  var _useState = (0, import_react10.useState)([0, 0]), size2 = _useState[0], setSize = _useState[1];
...
var getOtherUsers = function getOtherUsers2(chat, username) {
...
var getChatTitle = function getChatTitle2(chat, username) {
...
var OtherAvatars = function OtherAvatars2(props) {
  var otherUsers = getOtherUsers(props.chat, props.username);
  var memberOne = otherUsers.length > 0 ? otherUsers[0] : void 0;
  var memberTwo = otherUsers.length > 1 ? otherUsers[1] : void 0;
  var memberThree = otherUsers.length > 2 ? otherUsers[2] : void 0;
  return import_react10.default.createElement("div", {
    style: props.style
  }, import_react10.default.createElement(Avatar, {
    ...
    style: _extends2({}, styles.avatar, memberOne != null && memberOne.is_online ? styles.online : styles.offline, memberTwo && {
      width: "28px",
      height: "28px",
      lineHeight: "28px",
      fontSize: "12px"
  ...
  }), memberTwo && import_react10.default.createElement(Avatar, {
    className: "ce-custom-header-avatar",
    avatarUrl: memberTwo == null ? void 0 : memberTwo.avatar,
    username: memberTwo == null ? void 0 : memberTwo.username,
    style: _extends2({}, styles.avatar, memberOne != null && memberOne.is_online ? styles.online : styles.offline, {
      width: "28px",
      height: "28px",
      lineHeight: "28px",
      fontSize: "12px",
  ...
  }), memberThree && import_react10.default.createElement(Avatar, {
    className: "ce-custom-header-avatar",
    avatarUrl: memberThree == null ? void 0 : memberThree.avatar,
    username: memberThree == null ? void 0 : memberThree.username,
    style: _extends2({}, styles.avatar, memberThree != null && memberThree.is_online ? styles.online : styles.offline, {
      width: "21px",
      height: "21px",
      lineHeight: "21px",
      fontSize: "10px",
...
var nowTimeStamp = function nowTimeStamp2() {
  return (/* @__PURE__ */ new Date()).toISOString().replace("T", " ").replace("Z", Math.floor(Math.random() * 1e3) + "+00:00");
};
var ChatHeader = function ChatHeader2(props) {
  var _useState = (0, import_react10.useState)(false), isFilePickerLoading = _useState[0], setFilePickerLoading = _useState[1];
  var _useState2 = (0, import_react10.useState)(false), isDeleteLoading = _useState2[0], setDeleteLoading = _useState2[1];
  var otherMembers = props.chat ? getOtherUsers(props.chat, props.username) : [];
  var otherMember = otherMembers.length > 0 ? otherMembers[0] : void 0;
  var onFilesSelect = function onFilesSelect2(e) {
    if (!props.chat)
      return;
    ...
    axios_default.post("https://api.chatengine.io/chats/" + props.chat.id + "/messages/", formdata, {
      headers
    }).then(function() {
  ...
  var onDelete = function onDelete2() {
    if (!props.chat)
      return;
    ...
    axios_default["delete"]("https://api.chatengine.io/chats/" + props.chat.id + "/", {
      headers
    }).then(function(r) {
  ...
  return import_react10.default.createElement("div", {
    className: "ce-custom-chat-header",
    style: styles$1.chatHeader
  }, import_react10.default.createElement(OtherAvatars, {
    chat: props.chat,
  ...
  }, getChatTitle(props.chat, props.username)), import_react10.default.createElement("div", {
    className: "ce-custom-header-subtitle",
    style: styles$1.headerSubtitle
  }, otherMember.is_online ? "Online" : "Offline")), import_react10.default.createElement("div", {
    className: "ce-custom-header-icon-wrapper",
    style: styles$1.iconWrapper
  }, import_react10.default.createElement("form", {
    style: {
      display: "inline-block"
    }
  }, import_react10.default.createElement("label", {
    htmlFor: "ce-files-picker"
  }, isFilePickerLoading ? import_react10.default.createElement(LoadingOutlined_default, {
    style: {
      color: "rgb(153, 153, 153)"
    },
    className: "ce-custom-header-icon"
  }) : import_react10.default.createElement(PaperClipOutlined_default, {
  ...
  })), isDeleteLoading ? import_react10.default.createElement(LoadingOutlined_default, {
    style: {
      color: "rgb(153, 153, 153)"
    },
    className: "ce-custom-header-icon"
  }) : import_react10.default.createElement(DeleteFilled_default, {
    onClick: function onClick() {
      return onDelete();
    },
    className: "ce-custom-header-icon",
    style: styles$1.headerIcon
  })), import_react10.default.createElement("style", null, ".ce-custom-header-icon:hover { color: rgb(24, 144, 255) !important; }"));
};
var styles$1 = {
  chatAvatars: {
...
var ChatForm = function ChatForm2(props) {
  var didMountRef = (0, import_react10.useRef)(false);
  var _useState = (0, import_react10.useState)([]), options2 = _useState[0], setOptions = _useState[1];
  var _useState2 = (0, import_react10.useState)([]), selected = _useState2[0], setSelected = _useState2[1];
  (0, import_react10.useEffect)(function() {
    if (!didMountRef.current) {
      ...
      getAllUsers(function(users) {
        ...
        var options3 = otherUsers.map(function(user) {
          return {
  ...
  var getAllUsers = function getAllUsers2(onSuccess, onError) {
    axios_default.get("https://api.chatengine.io/users/search/", {
      headers: {
        "Project-ID": props.projectId,
        "User-Name": props.username,
        "User-Secret": props.secret
  ...
  }, import_react10.default.createElement(StateManagedSelect$1, {
    options: options2,
    autoFocus: true,
    isMulti: true,
    onChange: function onChange2(users) {
      setSelected(users);
      props.onChange(users);
    },
    styles: customStyles,
    placeholder: "Search for users..."
  }), import_react10.default.createElement("button", {
    className: "ce-create-chat-button",
    style: _extends2({}, styles$2.createChatButton, selected.length === 0 && styles$2.createChatButtonDisabled),
    onClick: props.onCancel,
    disabled: selected.length === 0
  }, import_react10.default.createElement(PlusOutlined_default, null)), import_react10.default.createElement("style", null, ".ce-create-chat-button:hover { background-color: #40a9ff; }"));
};
var customStyles = {
  ...
  noOptionsMessage: function noOptionsMessage2(provided) {
    return _extends2({}, provided, {
      fontFamily: "Avenir"
    });
  },
...
var CustomChatCard = function CustomChatCard2(props) {
  var chat = props.chat;
  if (chat === void 0)
    return import_react10.default.createElement("div", null);
  var otherUsers = getOtherUsers(chat, props.username);
  var otherMember = otherUsers.length > 0 ? otherUsers[0] : void 0;
  ...
  return import_react10.default.createElement("div", null, import_react10.default.createElement("style", null, "\n        .ce-chat-card:hover { border: 1px solid #1890ff !important; box-shadow: rgb(24 144 255 / 35%) 0px 2px 7px !important; }\n        .ce-chat-card-loading { height: 10px !important; }\n        .ce-chat-card-title-loading { top: 16px !important; }\n        "), import_react10.default.createElement(ChatCard, {
    ...
    renderAvatar: function renderAvatar() {
      return import_react10.default.createElement(OtherAvatars, {
        chat,
        username: props.username,
        style: {
          position: "relative",
...
var MessageForm = function MessageForm2(props) {
  var _useState = (0, import_react10.useState)(""), text = _useState[0], setText = _useState[1];
  var _useState2 = (0, import_react10.useState)(false), isFocused = _useState2[0], setIsFocused = _useState2[1];
  ...
  return import_react10.default.createElement("form", {
    onSubmit,
    ...
    style: _extends2({}, styles$3.messageInput, isFocused ? styles$3.messageInputFocused : {}),
  ...
  }), import_react10.default.createElement("style", null, ".ce-custom-message-input::placeholder { color: #e1e1e1; font-family: Avenir; }"), import_react10.default.createElement("button", {
    type: "submit",
    className: "ce-custom-send-button",
    style: _extends2({}, styles$3.sendButton)
  }, import_react10.default.createElement(CaretUpFilled_default, null)));
};
var styles$3 = {
  messageForm: {
    height: "68px",
...
var ChatListHeader = function ChatListHeader2(props) {
  return import_react10.default.createElement("div", {
    style: styles$4.chatListHeader
  }, import_react10.default.createElement("div", {
    style: styles$4.chatListHeaderTitle
  }, "Chats"), import_react10.default.createElement("button", {
    className: "ce-new-chat-button",
    style: styles$4.chatListHeaderButton,
    onClick: props.onNewChatClick
  }, import_react10.default.createElement(FormOutlined_default, null)), import_react10.default.createElement("style", null, ".ce-new-chat-button:hover { color: rgb(24, 144, 255) !important; }"));
};
var styles$4 = {
  chatListHeader: {
    display: "inline-block",
...
var PrettyChatWindow = function PrettyChatWindow2(props) {
  var _useState = (0, import_react10.useState)(false), isChatFormActive = _useState[0], setIsChatFormActive = _useState[1];
  var _useState2 = (0, import_react10.useState)([]), chatFormUsers = _useState2[0], setChatFromUsers = _useState2[1];
  ...
  function _getOrCreateChat() {
    _getOrCreateChat = _asyncToGenerator(_regeneratorRuntime().mark(function _callee() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              axios_default.put("https://api.chatengine.io/chats/", data, {
                headers
              }).then(function(r) {
  ...
  var onChatFormChange = function onChatFormChange2(options2) {
    var users = options2.map(function(option2) {
      return JSON.parse(option2.value);
    });
  ...
  return import_react10.default.createElement("div", {
  ...
  }, import_react10.default.createElement(MultiChatSocket, Object.assign({}, chatProps)), import_react10.default.createElement("div", {
    style: styles$5.col1
  }), import_react10.default.createElement("div", {
    style: isMobile ? styles$5.col0 : styles$5.col8
  }, import_react10.default.createElement(ChatList, Object.assign({}, chatProps, {
    renderChatForm: function renderChatForm() {
      return import_react10.default.createElement(ChatListHeader, {
        onNewChatClick: function onNewChatClick() {
          chatProps.setActiveChatId(void 0);
          setIsChatFormActive(true);
        }
      });
    },
    renderChatCard: function renderChatCard(props2) {
      return import_react10.default.createElement(CustomChatCard, Object.assign({}, props2, {
        ...
        isActive: props2.chat !== void 0 && chatProps.activeChatId === props2.chat.id,
        chat: props2.chat
      }));
    }
  }))), import_react10.default.createElement("div", {
    style: isMobile ? styles$5.col22 : styles$5.col14
  }, import_react10.default.createElement(ChatFeed, Object.assign({}, chatProps, {
    renderChatHeader: function renderChatHeader(chatHeaderProps) {
      if (isChatFormActive) {
        return import_react10.default.createElement(ChatForm, {
        ...
        return import_react10.default.createElement(ChatHeader, Object.assign({}, chatHeaderProps, {
          chat: chatProps.chat,
          projectId: chatProps.projectId,
          username: chatProps.username,
          secret: chatProps.secret,
    ...
    renderMessageList: function renderMessageList(props2) {
      return import_react10.default.createElement(MessageList, Object.assign({}, props2, {
        renderMessageList: void 0,
        messages: isChatFormActive ? [] : chatProps.messages
      }));
    },
    renderMessageForm: function renderMessageForm(props2) {
      if (isChatFormActive) {
        return import_react10.default.createElement("div", {
          style: styles$5.messageForm
        });
      } else {
        return import_react10.default.createElement(MessageForm, Object.assign({}, props2));
      }
    }
  }))), import_react10.default.createElement("div", {
    style: styles$5.col1
...
react-chat-engine-pretty/dist/react-chat-engine-pretty.esm.js:
  (*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE *)
*/
//# sourceMappingURL=react-chat-engine-pretty.js.map
